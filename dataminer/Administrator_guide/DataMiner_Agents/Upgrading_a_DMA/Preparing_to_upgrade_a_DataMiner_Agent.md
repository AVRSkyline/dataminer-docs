...
> - If you are upgrading to DataMiner 10.6.0.0, you need to [migrate to BrokerGateway](https://docs.dataminer.services/dataminer/DataMiner_Tools/BrokerGateway_Migration.html) first, which can only be done from 10.5.0 [CU4]/10.5.7 onwards.
